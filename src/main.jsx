...
function SocialIcon({ name }) {
  const icons = {
    ...
    threads: <path d="M12 2c5.52 0 10 4.48 10 10s-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2Zm.15 4.5c-2.72 0-4.65 1.7-4.65 4.1h2.05c0-1.25.95-2.15 2.55-2.15 1.5 0 2.45.75 2.45 1.95 0 .55-.18.95-.55 1.25-.48-.12-1-.18-1.55-.18-2.35 0-4.05 1.18-4.05 3.05 0 1.8 1.48 3.05 3.6 3.05 2.25 0 3.82-1.32 4.12-3.35.82.55 1.28 1.32 1.28 2.25 0 2.05-1.88 3.55-4.65 3.55-3.55 0-5.9-2.45-5.9-6.02 0-3.65 2.4-6.05 6.02-6.05 2.78 0 4.82 1.35 5.55 3.65l1.95-.65C19.42 8.05 16.6 6.5 12.15 6.5Zm.2 6.68c-.95 0-1.75.42-1.75 1.22 0 .78.68 1.22 1.55 1.22 1.02 0 1.72-.65 1.88-1.72-.42-.42-.98-.72-1.68-.72Z" />,
  };
